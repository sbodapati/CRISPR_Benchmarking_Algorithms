testCounts = read.table(file = "/Users/sbodapati/Documents/Qi Lab/Benchmarking/input/finalSimDatadf.csv", header = TRUE, sep=',')
head(testCounts)
...
write.csv(log2fc,'/Users/sbodapati/Documents/Qi Lab/Benchmarking/input/simulationl2fc.csv')
